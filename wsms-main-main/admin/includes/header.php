...
<div class="header-main">
  <div class="logo-w3-agile">
    <h1><a href="dashboard.php">WATER BOAT</a></h1>
  </div>
            ...
            <li><a href="#">
                ...
                <?php if ($num > 0) {
                  while ($result = mysqli_fetch_array($ret1)) {
                    ?>
                    <a class="dropdown-item" href="view-order.php?orderid=<?php echo $result['Ordernumber']; ?>"><i
                        class="fa fa-bell" style="color: red;"></i> #<?php echo $result['Ordernumber']; ?> Order Received
                      from <?php echo $result['FullName']; ?></a>
                  <?php }
                } else { ?>
      ...
      <li class="dropdown profile_details_drop">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
          <div class="profile_img">
            <span class="prfil-img"><img src="images/admin_img.png" height="150" width="100" alt=""> </span>
            <div class="user-name">
              <?php
